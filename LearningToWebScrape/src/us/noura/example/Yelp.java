...
*/
  ...
  public static void main(String[] args) {
    ...
    String consumerKey = "mDTMqfyR7uk5qZ7oJXfxzQ";
    String consumerSecret = "qDes5kGrBinSq938oyPF_7rmNSw";
    String token = "TiCbXQMxf5PVwGNCMtjBEKP3OAtPIMpa";
    String tokenSecret = "VB4rE1_Osl8PEX6aFqLyu8kK0H8";
